...
const PATHS = {
  ...
  sound: <path d="M4 9.4h3.6L12.4 5v14l-4.8-4.4H4zM15.6 9a4.2 4.2 0 0 1 0 6M18.2 6.4a8 8 0 0 1 0 11.2" />,
  muted: <path d="M4 9.4h3.6L12.4 5v14l-4.8-4.4H4zM15.8 9.4l5 5.2M20.8 9.4l-5 5.2" />,
  eye: (
    <>
